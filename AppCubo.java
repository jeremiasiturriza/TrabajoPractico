...
import olapcube.metricas.Contador;
import olapcube.metricas.Medida;
import olapcube.metricas.Promedio;
import olapcube.metricas.Max;
...
public class AppCubo {
    ...
    public static void main(String[] args) {
        ...
        List<Medida> medidas = Arrays.asList(new Suma(), new Contador(), new Promedio(), new Max());
            proyeccion.seleccionarMedida(medidas.get(3));
